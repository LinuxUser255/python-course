...
# PRACTICE THE ENTIRE LESSON

# LISTS

# Table of Contents
# First, review on Indexing and Slicing. We will be using this later on in the LISTS lesson.
...
# INDEXING AND SLICING REVIEW, WITH MORE DETAILED EXPLANATIONS
#
